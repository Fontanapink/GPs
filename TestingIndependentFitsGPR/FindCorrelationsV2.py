...
print(f"The maximal correlation between series a and b is: {correlation_results[('series_a', 'series_b')][0][max_lag]} at lag {max_lag}")
print(f"The maximal correlation between series a and c is: {correlation_results[('series_a', 'series_c')][0][max_lag]} at lag {max_lag}")
print(f"The maximal correlation between series b and c is: {correlation_results[('series_b', 'series_c')][0][max_lag]} at lag {max_lag}")
