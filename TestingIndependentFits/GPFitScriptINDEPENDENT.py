...
# -*- coding: utf-8 -*-
"""
Created on Mon Aug 2 15:00:00 2021
Author: Pedro Fontanarrosa

Description:
This script is the same as GPFitScript.py but it will independently fit each of the species
...
def plot_model(m, X, Y, P, L, K_L, M_F, BIC, i):
...
def main():
    ...
    for y in data.iloc[:, 1:].values.T:
        ...
        plot_model(m, timeSeries, y, P, L, K_L, M_F, BIC, i)
